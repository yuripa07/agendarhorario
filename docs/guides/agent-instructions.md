...
5. Atualize ou crie a documentação necessária e faça commit antes dos testes e da implementação.
...
8. Atualize o `HISTORY.md` da US ao concluir uma task.
...
4. Criar ou atualizar docs e commitar.
